...
const Landing = makeAsyncComponent('Landing', lazy(() => import('components/landing/landing')));
const LoginRoute = makeAsyncComponent('LoginRoute', lazy(() => import('components/login/login_route')));
